...
BRICS has converged to a level of diplomatic cohesion comparable to the G7. Within-group alignment among BRICS members rose from about 0.79 in 1990 to 0.92 in 2024, approaching the G7's stable cohesion of roughly 0.93. In the early post-Cold War period, the original BRICS members voted in substantially different patterns from one another; by 2024, they exhibit a degree of coalition discipline in the General Assembly that rivals the Western democracies. This represents a structural transformation in the diplomatic landscape that single-dyad or snapshot approaches would fail to detect.

South Korea stands out as one of the largest sustained movers toward US positions over the past three decades. US-South Korea alignment rose from about 0.59 in 1990 to 0.86 in 2024, a trajectory that reflects Seoul's deepening integration into the US-led democratic alliance structure and its increasing willingness to break from the Global South consensus on issues the US prioritizes. Few countries exhibit a shift of this magnitude sustained over such a long period.
...
The interactive dashboard provides several views of the data. A world map displays the US-China tilt for any year from 1990 to 2024. The country explorer produces a full alignment profile for any state, including scores relative to the US, China, the G7, and BRICS, along with trajectory charts and lists of most and least aligned partners. The dyad comparison tool tracks structural alignment between any two countries over time with reference benchmarks. The bloc dashboard presents within-group cohesion and member-level tilt for G7, BRICS, BRICS+, NATO, ASEAN, and the Global South. The alignment space page displays the two-dimensional latent positions underlying the scores, allowing users to watch countries move in diplomatic space across years.
